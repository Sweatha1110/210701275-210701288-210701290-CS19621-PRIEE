        ...
        <header>
            <div className="container">
                ...
                <div className="category-container">
                    <ul>
                        <li><Link to="/category/bag">Bag</Link></li>
                        <li><Link to="/category/essential">Essentials</Link></li>
                        <li><Link to="/category/art">Art</Link></li>
                        <li><Link to="/category/sculpture">Sculpture</Link></li>
